import { Component, OnInit, EventEmitter, Output, OnChanges, SimpleChange, SimpleChanges } from '@angular/core';
...
export class TaskmanagementDetailComponent implements OnChanges, OnInit {
  ...
  ngOnInit() {
    ...
    this.router.events.subscribe((event) => {
      if (event instanceof NavigationStart && event.url.indexOf('/taskmanagement/') !== -1) {
        this.loading = true;
      }
    });
  }
